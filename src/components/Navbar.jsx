...
const Navbar = ({ theme, setTheme}) => {
    ...
    xl:px-40 py-4 sticky top-0 z-20  backdrop-blur-xl font-medium bg-white/60 dark:bg-gray-900/40'>
            ...
            <div className={`text-gray-700 dark:text-white sm:text-sm ${!sidebarOpen ? 'max-sm:w-0 overflow-hidden' : 'max-sm:w-60 max-sm:pl-10'} 
                ...
                max-sm:h-full max-sm:flex max-sm:flex-col max-sm:bg-primary max-sm:text-white 
