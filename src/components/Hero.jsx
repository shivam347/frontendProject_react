...
const Hero = () => {
    ...
    text-center w-full overflow-hidden text-gray-700'>
      ...
      pr-40 rounded-full'>
            ...
            <h1 className='text-xl sm:text-5xl md:text-6xl xl:text-[84px] font-medium xl:leading-[95px] max-w-5xl'>Turning imagination into 
            ...
            dark:text-white/75 max-w-4/5 sm:max-w-lg pb-3'>Creating meaningful connections and turning big ideas into interactive digital experiences.</p>
